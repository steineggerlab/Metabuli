...
querySplits, queryKmerList, targetDiffIdxList, targetInfoList, matchBuffer, cout, genusTaxIdList, taxIdList, spTaxIdList, matchFile, sspOrSp, par)
        {
            //query variables
...
#pragma omp atomic
                    ...
                    while (AminoAcidPart(currentQuery) == AminoAcidPart(currentTargetKmer) &&
                           (targetInfoIdx < numOfTargetKmer) && (diffIdxPos != numOfDiffIdx)) {
                        if(genusTaxIdList[targetInfoList.data[targetInfoIdx].sequenceID] == 139585){
                            ...
                            cout<<"\n";
                            cout<< getHammingDistanceSum(currentQuery,currentTargetKmer) << endl;
                        }
//@@@@
//                        cout<<"Q: ";seqIterator.printKmerInDNAsequence(currentQuery);
//                        print_binary64(64,currentQuery);
