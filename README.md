...
Two files you need:
1. **List of FASTA files** : A list of paths to sequence files to be added. Sequences must be separated by '>accession'.
2. **accession2taxid** : Mapping from accession to taxonomy ID. The sequences whose accessions are not listed here will be skipped.
...
# accession2taxid
Saccharomyces_cerevisiae_accession_1  10000013
Saccharomyces_cerevisiae_accession_2  10000013
Saccharomyces_cerevisiae_accession_3  10000013
```
