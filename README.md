...
metabuli classify --seq-mode 3 read.fna dbdir outdir jobid
  ...
  * Important parameters:
   ...
   -e : Ignore matches with larger E-value (0: disable)
...
7. `rank`: Taxonomic rank of the taxon
8. `taxID:match_count`: List of "taxID : k-mer match count"
...
```
metabuli refine-result <i:read-by-read classification> <i:DBDIR> [options]
...
* Options
   ...
   --select-taxid : Remain the specified taxa as well as children (e.g., 1758,9685)
